...
cannoli::LightRay cannoli::MetalBRDF::Scatter(const LightRay &ray_in, const PointXYZ &hit_point, const Vec3f &surf_normal) {
  ...
  LightRay reflected_ray(hit_point, reflection_dir);
